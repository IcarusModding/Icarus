...
public class DML : ModuleRules
{
    public DML(ReadOnlyTargetRules Target) : base(Target)
    {
        ...
        PublicDependencyModuleNames.AddRange(new string[] {"Icarus"});
        ...
        if (currentBranch != null && buildId != null) {
            ...
            PrivateDefinitions.Add(string.Format("DML_BUILD_METADATA=\"{0}\"", buildMetadataString));
        }
    }
