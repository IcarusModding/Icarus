...
const TCHAR* DMLConfigModVersionField = TEXT("DML_ModVersion_DoNotChange");
...
void UConfigManager::SaveConfigurationInternal(const FConfigId& ConfigId) {
    ...
    //     UnderlyingObject->SetStringField(DMLConfigModVersionField, ModVersion);
    // }
...
void UConfigManager::LoadConfigurationInternal(const FConfigId& ConfigId, URootConfigValueHolder* RootConfigValueHolder, bool bSaveOnSchemaChange) {
    ...
    //     const FString ModVersion = ModInfo.Version.ToString();
    //     FString FileVersion;
    //     if (JsonObject->HasTypedField<EJson::String>(DMLConfigModVersionField)) {
    //         FileVersion = JsonObject->GetStringField(DMLConfigModVersionField);
    //     }
...
void UConfigManager::RegisterModConfiguration(TSubclassOf<UModConfiguration> Configuration) {
    ...
    UE_LOG(LogDaedalusModLoader, Log, TEXT("Registering configuration %s"), *Configuration->GetPathName());
