...
void UGameInstanceModuleManager::Initialize(FSubsystemCollectionBase& Collection) {
    ...
    EnsureDMLSubsystemsInitialized();
    ...
    for (const FDiscoveredModule& Module : DiscoveredModules) {
        ...
        if (AlreadyLoadedMods.Contains(Module.OwnerPluginName)) {
            ...
            UE_LOG(LogDaedalusModLoader, Fatal, TEXT("Failed to initialize Game Instane Module for Plugin %s: "
    ...
    UE_LOG(LogDaedalusModLoader, Log, TEXT("Discovered %d game instance modules"), AlreadyLoadedMods.Num());
...
void UGameInstanceModuleManager::EnsureDMLSubsystemsInitialized() {
    // TODO
}
...
void UGameInstanceModuleManager::DispatchLifecycleEvent(ELifecyclePhase Phase) {
    ...
    UE_LOG(LogDaedalusModLoader, Log, TEXT("Dispatching lifecycle event %s to game instance modules"),
