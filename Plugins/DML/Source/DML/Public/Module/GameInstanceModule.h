...
struct DML_API FModKeyBindingInfo {
    GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct DML_API FModAxisBindingInfo {
    GENERATED_BODY()
...
class DML_API UGameInstanceModule : public UModModule {
    GENERATED_BODY()
public:    
    ...
    /**
    * List of classes for objects implementing IDMLItemTooltipProvider
