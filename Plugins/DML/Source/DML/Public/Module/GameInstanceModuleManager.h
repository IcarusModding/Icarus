...
UCLASS()
class DML_API UGameInstanceModuleManager : public UGameInstanceSubsystem {
    GENERATED_BODY()
private:
...
public:
     ...
     * NOTE: only needed for custom subsystems, DML subsystems are already pre-initialized.
     */
...
private:
    ...
    void EnsureDMLSubsystemsInitialized();
