...
UCLASS()
class DML_API UBlueprintLoggingLibrary : public UBlueprintFunctionLibrary {
    GENERATED_BODY()
public:
    /**
    * Logs the given string in verbose level to the DML Log file and the game log in the LogYourModReference category
    */
    UFUNCTION(BlueprintCallable, Category = "DML|Logging", CustomThunk, meta = (BlueprintThreadSafe))
    static void LogVerbose(const FString& Str) BP_FUNCTION_ONLY_STUB();

    /**
    * Logs the given string in display level to the DML Log file and the game log in the LogYourModReference category
    */
    UFUNCTION(BlueprintCallable, Category = "DML|Logging", CustomThunk, meta = (BlueprintThreadSafe))
    static void LogDisplay(const FString& Str) BP_FUNCTION_ONLY_STUB();
	
    /**
    * Logs the given string in warning level to the DML Log file and the game log in the LogYourModReference category
    */
    UFUNCTION(BlueprintCallable, Category = "DML|Logging", CustomThunk, meta = (BlueprintThreadSafe))
    static void LogWarning(const FString& Str) BP_FUNCTION_ONLY_STUB(); 

    /**
    * Logs the given string in error level to the DML Log file and the game log in the LogYourModReference category
    */
    UFUNCTION(BlueprintCallable, Category = "DML|Logging", CustomThunk, meta = (BlueprintThreadSafe))
    static void LogError(const FString& Str) BP_FUNCTION_ONLY_STUB();

    /**
    * Logs the given string in fatal level to the DML Log file and the game log in the LogYourModReference category. This crashes the game!
    */
    UFUNCTION(BlueprintCallable, Category = "DML|Logging", CustomThunk, meta = (BlueprintThreadSafe))
