...
UCLASS()
class DML_API URuntimeBlueprintFunctionLibrary : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
...
public:
		...
		*/
		UFUNCTION(BlueprintCallable, Category = "DML | Class")
		static UClass * FindClassByName(FString ClassNameInput);
		
		/** Returns true in Editor*/
		UFUNCTION(BlueprintPure, Category = "DML")
		static bool IsEditor();

		/** Retrieves FName from UConfigProperty */
		UFUNCTION(BlueprintPure, meta = (DisplayName = "CP to Name", CompactNodeTitle = "To Name", BlueprintAutocast), Category = "DML | Utilities")
		static FName Conv_ConfigPropertyToName(UConfigProperty * Property);
		/** Retrieves FText from UConfigProperty */
		UFUNCTION(BlueprintPure, meta = (DisplayName = "CP to Text", CompactNodeTitle = "To Text", BlueprintAutocast), Category = "DML | Utilities")
		static FText Conv_ConfigPropertyToText(UConfigProperty * Property);
		/** Retrieves FString from UConfigProperty */
		UFUNCTION(BlueprintPure, meta = (DisplayName = "CP to String", CompactNodeTitle = "To String", BlueprintAutocast), Category = "DML | Utilities")
		static FString Conv_ConfigPropertyToString(UConfigProperty * Property);
		/** Retrieves Float from UConfigProperty */
		UFUNCTION(BlueprintPure, meta = (DisplayName = "CP to Float", CompactNodeTitle = "To Float", BlueprintAutocast), Category = "DML | Utilities")
		static float Conv_ConfigPropertyToFloat(UConfigProperty * Property);
		/** Retrieves int32 from UConfigProperty */
		UFUNCTION(BlueprintPure, meta = (DisplayName = "CP to Int", CompactNodeTitle = "To Int", BlueprintAutocast), Category = "DML | Utilities")
		static int32 Conv_ConfigPropertyToInteger(UConfigProperty * Property);
		/** Retrieves Bool from UConfigProperty */
		UFUNCTION(BlueprintPure, meta = (DisplayName = "CP to Bool", CompactNodeTitle = "To Bool", BlueprintAutocast), Category = "DML | Utilities")
		static bool Conv_ConfigPropertyToBool(UConfigProperty * Property);
		
		/** Retrieves int32 from UConfigPropertyInteger */
		UFUNCTION(BlueprintPure, meta = (DisplayName = "CPF To Float", CompactNodeTitle = "To Float", BlueprintAutocast), Category = "DML | Utilities")
		static float Conv_ConfigPropertyFloatToFloat(UConfigPropertyFloat * Property) ;
		/** Retrieves int32 from UConfigPropertyInteger */
		UFUNCTION(BlueprintPure, meta = (DisplayName = "CPI To Integer", CompactNodeTitle = "To Int", BlueprintAutocast), Category = "DML | Utilities")
		static int32 Conv_ConfigPropertyIntegerToInteger(UConfigPropertyInteger * Property);
		/** Retrieves Bool from UConfigPropertyBool */
		UFUNCTION(BlueprintPure, meta = (DisplayName = "CPB To Bool", CompactNodeTitle = "To Bool", BlueprintAutocast), Category = "DML | Utilities")
		static bool Conv_ConfigPropertyBoolToBool(UConfigPropertyBool * Property);
		/** Retrieves String from UConfigPropertyString */
		UFUNCTION(BlueprintPure, meta = (DisplayName = "CBS To String", CompactNodeTitle = "To String", BlueprintAutocast), Category = "DML | Utilities")
		...
		UFUNCTION(BlueprintPure, meta = (DisplayName = "To Section", CompactNodeTitle = ".", BlueprintAutocast), Category = "DML | Utilities")
		...
		UFUNCTION(BlueprintPure, meta = (DisplayName = "To Array", CompactNodeTitle = "[]", BlueprintAutocast), Category = "DML | Utilities")
		...
		UFUNCTION(BlueprintPure, meta = (DisplayName = "CPArray To String Array", CompactNodeTitle = "[String]", BlueprintAutocast), Category = "DML | Utilities")
		...
		UFUNCTION(BlueprintPure, meta = (DisplayName = "CPArray To Float Array", CompactNodeTitle = "[Float]", BlueprintAutocast), Category = "DML | Utilities")
		...
		UFUNCTION(BlueprintPure, meta = (DisplayName = "CPArray To Int Array", CompactNodeTitle = "[Int]", BlueprintAutocast), Category = "DML | Utilities")
		...
		UFUNCTION(BlueprintPure, meta = (DisplayName = "CPArray To Bool Array", CompactNodeTitle = "[Bool]", BlueprintAutocast), Category = "DML | Utilities")
		...
		UFUNCTION(BlueprintPure, meta = (DisplayName = "CP to Widget", CompactNodeTitle = "To Widget", BlueprintAutocast, DefaultToSelf = "ParentWidget", HidePin = "ParentWidget"), Category = "DML | Utilities")
		...
		UFUNCTION(BlueprintPure, meta = (DisplayName = "CP to UserWidget", CompactNodeTitle = "To UWidget", BlueprintAutocast, DefaultToSelf = "ParentWidget", HidePin = "ParentWidget"), Category = "DML | Utilities")
		...
		UFUNCTION(BlueprintPure, meta = (DisplayName = "MC to ConfigProperty", CompactNodeTitle = "To Instance", BlueprintAutocast, WorldContext = "WorldContextObject"), Category = "DML | Utilities")
		...
		UFUNCTION(BlueprintPure, meta = (DisplayName = "ConfigId to ConfigProperty", CompactNodeTitle = "To Instance", BlueprintAutocast, WorldContext = "WorldContextObject"), Category = "DML | Utilities")
		static UConfigProperty * Conv_ConfigIdToConfigProperty(const FConfigId & ConfigId);

		/** Converts Config Id to Configuration Class */
		UFUNCTION(BlueprintPure, meta = (DisplayName = "ConfigId to Configuration Class", CompactNodeTitle = "To Config Class", BlueprintAutocast, WorldContext = "WorldContextObject"), Category = "DML | Utilities")
		...
		static UUserWidget* CreateDMLWidget(UUserWidget* OwningObject, TSubclassOf<UUserWidget> UserWidgetClass, FName WidgetName);
