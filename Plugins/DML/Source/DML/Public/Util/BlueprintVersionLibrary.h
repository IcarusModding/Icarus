...
UCLASS()
class DML_API UBlueprintVersionLibrary : public UBlueprintFunctionLibrary {
    GENERATED_BODY()
public:
    /** Constructs SemVer Version from version string */
    UFUNCTION(BlueprintPure, Category = "DML|Versioning", meta = (BlueprintThreadSafe))
    ...
    UFUNCTION(BlueprintPure, Category = "DML|Versioning", meta = (DisplayName = "ToString (Version)", CompactNodeTitle = "->", ScriptMethod="ToString", BlueprintThreadSafe))
    ...
    /** Converts version data to the string */
    UFUNCTION(BlueprintPure, Category = "DML|Versioning", meta = (DisplayName = "ToString (VersionRange)", CompactNodeTitle = "->", ScriptMethod="ToString", BlueprintThreadSafe))
    ...
    UFUNCTION(BlueprintPure, Category = "DML|Versioning", meta = (DisplayName = "Matches (Version)", BlueprintThreadSafe))
