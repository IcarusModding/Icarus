...
struct DML_API FConfigVariableDescriptor {
    GENERATED_BODY()
public:
...
template<>
struct DML_API TStructOpsTypeTraits<FConfigVariableDescriptor> : public TStructOpsTypeTraitsBase2<FConfigVariableDescriptor> {
    enum {
        WithCopy = true,
