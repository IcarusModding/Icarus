...
class DML_API FReflectedObjectState {
public:
...
struct DML_API FReflectedPropertyInfo {
    GENERATED_BODY()
public:
...
USTRUCT(BlueprintType)
struct DML_API FReflectedEnumValue {
    GENERATED_BODY()
public:
    FReflectedEnumValue();
...
USTRUCT(BlueprintType)
struct DML_API FReflectedObject {
    GENERATED_BODY()
public:
...
template<>
struct DML_API TStructOpsTypeTraits<FReflectedObject> : public TStructOpsTypeTraitsBase2<FReflectedObject> {
    enum {
        WithCopy = true,
...
class DML_API FReflectedObjectState_Array : public FReflectedObjectState {
public:
...
class DML_API FReflectedObjectState_UObject : public FReflectedObjectState {
public:
...
class DML_API FReflectedObjectState_ScriptStruct : public FReflectedObjectState {
public:
