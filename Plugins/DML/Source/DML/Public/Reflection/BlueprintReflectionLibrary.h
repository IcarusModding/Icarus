...
UCLASS()
class DML_API UBlueprintReflectionLibrary : public UBlueprintFunctionLibrary {
    GENERATED_BODY()
public:
    ...
    DECLARE_FUNCTION(execGetClassDefaultObject) {
        ...
        if (PackageOwner != ClassOwner) {
            UE_LOG(LogDaedalusModLoader, Warning, TEXT("Blueprint %s, owned by %s, is accessing CDO of class %s, owned by %s"),
